...
int main() {
    ...
    while (1) {
        ...
        scanf(" %c", &word);
        fflush(stdin);// Make the input buffer empty
...
//I learned a lot about the application of structures in this assignment.
// The principles of structures are not difficult. Many parts are based on what I have learned before,
// such as loops and size comparisons. But compared with what I learned before, 
//the structure You need to pay more attention to the details, 
//and you must be very clear about what you are typing when announcing and the order of content, 
